    ...
    return (
        <div className="max-w-2xl mx-auto flex flex-col items-center justify-center px-4 md:px-0">
            <SectionTitle 
                ...
                text3="Crea hermosas interfaces sin complicaciones — componentes personalizables, escalables y fáciles de usar para desarrolladores."  
            />
            <div className="mt-8">
                {faqsData.map((faq, index) => (
                    ...
                    >
                        ...
                        <p 
                            className={`text-sm text-slate-500 transition-all duration-500 ease-in-out max-w-xl ${
                                openIndex === index 
