...
export default function ContactForm() {
    ...
    return (
        <section id="contacto" className="py-24 bg-sky-50 overflow-hidden" aria-labelledby="contact-title">
            <div className="w-full max-w-[1650px] px-6 md:px-10 lg:px-12 xl:px-16 2xl:px-20 mx-auto">
                <div className="grid lg:grid-cols-2 gap-12 items-stretch">
                    ...
                    >
                        <h2 id="contact-title" className="text-3xl font-semibold text-slate-900 mb-4 tracking-tight">
                            Have questions?
                        </h2>
                        ...
                        <form className="space-y-5" aria-label="Contact form">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    <label htmlFor="name" className="block text-xs font-bold text-sky-900 uppercase tracking-wider mb-2 ml-1">Your name</label>
                                    <input 
                                        type="text" 
                                        id="name"
                                        name="name"
                                ...
                                <div>
                                    <label htmlFor="email" className="block text-xs font-bold text-sky-900 uppercase tracking-wider mb-2 ml-1">Email address</label>
                                    <input 
                                        type="email" 
                                        id="email"
                                        name="email"
                            ...
                            <div>
                                <label htmlFor="subject" className="block text-xs font-bold text-sky-900 uppercase tracking-wider mb-2 ml-1">Subject</label>
                                <input 
                                    type="text" 
                                    id="subject"
                                    name="subject"
                            ...
                            <div>
                                <label htmlFor="message" className="block text-xs font-bold text-sky-900 uppercase tracking-wider mb-2 ml-1">Message</label>
                                <textarea 
                                    id="message"
                                    name="message"
                                    rows="4" 
                            ...
                            <div className="flex items-start gap-3 py-2">
                                <input type="checkbox" id="consent" required className="mt-1 w-5 h-5 cursor-pointer accent-sky-700 rounded border-slate-300 transition-all" />
                                <label htmlFor="consent" className="text-[11px] text-slate-500 leading-snug cursor-pointer select-none">
                                    I wish to receive information from Purinapaq. I understand that I can withdraw my consent at any time.
                                </label>
                            </div>

                            <button type="submit" className="group w-full py-4 bg-sky-700 hover:bg-sky-800 text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2 shadow-lg shadow-sky-700/25 active:scale-[0.98]">
                                ...
                                <address className="not-italic space-y-10">
                                    <div className="flex items-start gap-6 group">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:info@purinapaq.org" className="text-lg font-medium hover:text-sky-300 transition-colors">info@purinapaq.org</a>
                                        </div>
                                    </div>
            ...
            <div className="sr-only">
                ...
                <p>Reach out to our Etobicoke office for wheelchair donations, volunteer opportunities, and mobility assistance programs in Canada and Peru.</p>
            </div>
        </section>
    );
}